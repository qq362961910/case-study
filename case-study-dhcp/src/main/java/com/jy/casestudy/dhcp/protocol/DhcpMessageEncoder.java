...
import com.jy.casestudy.dhcp.constants.HardwareType;
import com.jy.casestudy.dhcp.constants.OperationType;
import com.jy.casestudy.dhcp.constants.OptionType;
...
public class DhcpMessageEncoder {
    ...
    public byte[] encode(DiscoverMessage message) {
        ...
        //4.设置请求IP选项
        if(message.getExpectIp() != null && message.getExpectIp().length>0) {
